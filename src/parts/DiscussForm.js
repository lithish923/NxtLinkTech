...
export const DiscussForm = (actions) => {
  ...
  const submitEmail = () => {
    ...
    const templateParams = {
      ...
      to_email: 'nxtlinktech@gmail.com',
      message: projectIdea,
    };
    ...
    <section className="flex flex-col container mx-auto mt-10 justify-center">
      ...
      <Fade direction="up" triggerOnce>
        <div className="flex flex-col">
          ...
          <Button
            className="text-xl mx-auto px-12 py-3 mt-5 bg-red-600 text-white rounded-full border-2 border-red-700 hover:bg-red-700 transition duration-200 focus:outline-none"
            type="button"
            onClick={submitEmail}
          >
          Submit
