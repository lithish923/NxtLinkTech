  ...
  return (
    <header className="header">
      ...
      <ul className="hidden text-theme-blue tracking-widest items-center lg:flex flex-row mt-0">
        ...
        <li>
          <Button
            className="font-medium text-lg mx-auto ml-3 px-6 py-2 bg-red-500 text-white rounded-full border-2 border-red-500 hover:bg-red-700 transition duration-200"
            type="link"
        ...
        <div className="transition duration-300 ease-in data-[closed]:opacity-0">
          <ul className="z-50 flex flex-col text-theme-blue tracking-widest my-6 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
            ...
            <li className="mx-auto my-9 bg-white">
              <Button
                className="font-bold mx-auto px-5 py-2 bg-red-500 text-white rounded-full border-2 border-red-500 hover:bg-red-700 transition duration-200"
                type="link"
                href="/discuss-project"
              >
                Discuss Project
