        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row mb-5">
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-red-500 text-lg border border-red-500 rounded-full transition duration-300 hover:bg-red-500 hover:text-white focus:outline-none focus:bg-red-500 focus:text-white">Mobile</button>
              </Tab>
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-red-500 text-lg border border-red-500 rounded-full transition duration-300 hover:bg-red-500 hover:text-white focus:outline-none focus:bg-red-500 focus:text-white">Website</button>
              </Tab>
              <Tab>
                <button className="font-normal px-8 py-2 text-red-500 text-lg border border-red-500 rounded-full transition duration-300 hover:bg-red-500 hover:text-white focus:outline-none focus:bg-red-500 focus:text-white">UI/UX</button>
              </Tab>
            </div>
          </TabList>
